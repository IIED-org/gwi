...
$databases = array (
  ...
  array (
    'default' => 
    array (
      'database' => 'gwi_dev_drupal',
      'username' => 'gwi_dev',
      'password' => 'TqPxw&@P386C',
      'host' => 'localhost',
      'port' => '',
      'driver' => 'mysql',
      'prefix' => '',
 ...
 *
 */
$drupal_hash_salt = 'eleTccmnSt0lCpprq9aOZAPmSCkmsX6nSAVSgWst3-o';
 ...
 */
 $conf['locale_custom_strings_en'][''] = array(
    'Search this site' => 'Search our site and library',
 );
...
if (isset($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR']) && file_exists($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/cld_devcloud_gwi_dev_default.inc')) {
  require $_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/cld_devcloud_gwi_dev_default.inc';
}
// </DDSETTINGS>
